 ...
 */
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        Person1 p1 = new Person1("Lisna Vargheese");
        toPrint += p1.toString("lvargheese3");
        //Person2 replace P2 with your name
        //and gburdell with your gt id
        Person2 p2 = new Person2("Priya Mehta");
        toPrint += p2.toString("pmehta77");
        //Person3 replace P3 with your name
        //and gburdell3 with your gt id
        Person3 p3 = new Person3("Divya Yagnamurthy");
        toPrint += p3.toString("dyagnamurthy3");
        //Person4 replace P4 with your name
        //and gburdell4 with your gt id
        Person4 p4 = new Person4("Mason Buchanan");
        toPrint += p4.toString("sbuchanan8");
